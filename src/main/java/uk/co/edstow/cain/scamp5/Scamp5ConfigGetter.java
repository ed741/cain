...
public interface Scamp5ConfigGetter<G extends Goal<G>, T extends Transformation<R>, R extends Register, SELF extends Scamp5ConfigGetter.Scamp5Config<G, SELF>> {
    PairGenFactory.PairGen<G,T,R> getScamp5Strategy(GoalBag<G> goals, Context<G,T,R> context, boolean movOnly);
    default PairGenFactory.PairGen<G,T,R> getScamp5Strategy(GoalBag<G> goals, Context<G,T,R> context){
