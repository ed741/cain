...
public class ArrayGoal implements Goal3DAtomLike<ArrayGoal> {
    ...
    private ArrayGoal(int[] array, int centerX, int centerY, int centerZ, int xSize, int ySize, int zSize, int total) {
        this.arr = array;
    ...
    private ArrayGoal(int[] array, int centerX, int centerY, int centerZ, int xSize, int ySize, int zSize) {
        this.arr = array;
        this.centerX = centerX;
        this.centerY = centerY;
        this.centerZ = centerZ;
    ...
    @Override
    public Goal3DAtomLikeFactory<ArrayGoal> newFactory() {
        return new Factory();
    }

    public static class Factory implements Goal3DAtomLikeFactory<ArrayGoal> {
        ...
        @Override
        public Goal3DAtomLikeFactory<ArrayGoal> add(int x, int y, int z, int v) {
            map.compute(new Coord(x, y, z), (coord, c) -> (c==null?0:c)+v);
            return this;
        }

        @Override
        public Goal3DAtomLikeFactory<ArrayGoal> sub(int x, int y, int z, int v) {
            map.compute(new Coord(x, y, z), (coord, c) -> (c==null?0:c)-v);
            return this;
        }

        @Override
        public Goal3DAtomLikeFactory<ArrayGoal> add(ArrayGoal goal) {
        ...
        @Override
        public Goal3DAtomLikeFactory<ArrayGoal> sub(ArrayGoal goal) {
            for (int i = 0; i < goal.arr.length; i++) {
                int v = goal.arr[i];
                if (v != 0){
                    int z = i % goal.zSize;
        ...
        @Override
        public Goal3DAtomLikeFactory<ArrayGoal> addAll(Collection<ArrayGoal> goals) {
