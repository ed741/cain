...
public class Scamp5PairGenFactory implements PairGenFactory {
    ...
    public interface ConfigGetter {
        Config getConfig(Goal.Bag goals, int depth, ReverseSearch rs, boolean initialGoal);
    }
